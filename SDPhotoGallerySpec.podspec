#
#  Be sure to run `pod spec lint SDPhotoGallerySpec.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of SDPhotoGallerySpec in Markdown format.
  ...
  s.homepage     = "https://github.com/SeductiveMobile/SDPhotoGallery"
  ...
  s.source       = { :git => "https://github.com/SeductiveMobile/SDPhotoGallery.git", :tag => "0.0.3" } 
